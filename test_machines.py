...
def make_3x3_grid(capacity, mparams=None):
    ...
    j = [m.add_junction(i) for i in range(6)]
    m.add_segment(0, t[0], j[0], 'L')
    m.add_segment(1, t[1], j[1], 'L')
    m.add_segment(2, t[2], j[2], 'L')
    m.add_segment(3, t[3], j[3], 'R')
    m.add_segment(4, t[4], j[4], 'R')
    m.add_segment(5, t[5], j[5], 'R')
    ...
    m.add_segment(9,  t[6], j[3], 'R')
    m.add_segment(10, t[7], j[4], 'R')
    m.add_segment(11, t[8], j[5], 'R')
